...
Il est aussi très recommandé de rejoindre le [canal de discussion Gitter dédié](https://gitter.im/neo4j-developer-training) à la formation et à ces exercices afin de pouvoir poster toutes vos questions.
...
Au moment de l'écriture de ces lignes, la dernière version stable embarquée dans Neo4j Desktop est la version 3.4.6.
